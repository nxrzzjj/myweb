...
<section class="products2">
 ...
 -->
	...
	<form action="FindSelectedDoctorServlet" method="post">
...
<%
			ArrayList<User> list3 = (ArrayList<User>) session.getAttribute("list3");
	...
	<table align="center" bordercolor="#2a5caa">
		...
		<tr>
			...
			<td><a class="btn btn-success btn-sm"
				href="javascript:location.href=encodeURI(encodeURI('OrderAdd.jsp?dname=<%=info.getDname()%>&dnumber=<%=info.getDnumber()%>'))">预约</a>
		</tr>
		<%
			}
			}
    ...
    <a class="btn btn-success btn-sm" href="UserInfo.jsp">返回用户中心</a>
	 </div>
     </div>
</section>
</body>
